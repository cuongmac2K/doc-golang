...
func main() {
	...
	urls := []string{
		"http://domain/namespaces/abc/directories",
		"http://domain/namespaces/abc/get-capacity",
		...
		"https://hn-staging2.bizflycloud.vn/api/_/abcd1234efgh5678/0123456789ABCDEFabcdef012345/123e4567-e89b-42d3-a456-426614174000",
	}
