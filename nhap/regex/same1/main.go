...
func main() {
	...
	//	"[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12}",
	//}
	//"/domains/*/namespaces/*/get-capacity"
	//baseURL := "https://hn-staging2.bizflycloud.vn/api/domains/123e4567-e89b-42d3-a456-426614174000/namespaces/abjjc/get-capacity"
	//patterns := []string{
	//	"[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12}",
	//	"namespaces/(.*?)/get-capacity",
	//}
